...
def oxygen_cylinder_update(req):
    ...
    return render(req, 'oxygen_cylinder_update.html',context)
def oxygen_bed_update(req):
    ...
    context = {"tot": tot,'use':use,'hospital':o,}
    return render(req, 'oxygen_bed_update.html',context)
...
def supplier_detail(req):
    ...
    return render(req, 'supplier_details.html',context)
...
def supplier_details_update(req):
    ...
    return render(req, 'supplier_details_update.html', context)
